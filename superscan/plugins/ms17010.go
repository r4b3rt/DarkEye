...
//:) derived from https://github.com/jflyup/goMS17-010
var (
...
func init() {
	checkFuncs[MS17010] = ms17010Check
}

func ms17010Check(plg *Plugins) interface{} {
	if plg.TargetPort != "445" {
		return nil
	}
	plg.TargetProtocol = "[SMB]"
	pocMS17010(plg)
	return &plg.Ms17010
}

func pocMS17010(plg *Plugins) (vul bool) {
	...
	if reply[9] == 0x05 && reply[10] == 0x02 && reply[11] == 0x00 && reply[12] == 0xc0 {
		...
		if reply[34] == 0x51 {
			plg.Ms17010.Description += "+DOUBLE PULSAR SMB IMPLANT"
		}
