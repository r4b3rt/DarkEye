...
type MainWindow struct {
	...
	*widgets.QMainWindow
	...
	Poc_tab                     *widgets.QWidget
	Poc_log                     *widgets.QTextEdit
	Poc_url                     *widgets.QLineEdit
	Poc_url_label               *widgets.QLabel
	Poc_import_urls             *widgets.QPushButton
	Poc_start                   *widgets.QPushButton
	Poc_stop                    *widgets.QPushButton
	Poc_reverse_url_label       *widgets.QLabel
	Poc_reverse_url             *widgets.QLineEdit
	Poc_reverse_url_check_label *widgets.QLabel
	Poc_reverse_url_check       *widgets.QLineEdit
	Poc_listen                  *widgets.QCheckBox
	Poc_file                    *widgets.QLineEdit
	Poc_import_file             *widgets.QPushButton
...
func (w *MainWindow) setupUI() {
	w.Poc_stop = widgets.NewQPushButtonFromPointer(w.FindChild("poc_stop", core.Qt__FindChildrenRecursively).Pointer())
	...
	w.Poc_tab = widgets.NewQWidgetFromPointer(w.FindChild("poc_tab", core.Qt__FindChildrenRecursively).Pointer())
	w.Poc_start = widgets.NewQPushButtonFromPointer(w.FindChild("poc_start", core.Qt__FindChildrenRecursively).Pointer())
	...
	w.Poc_reverse_url_label = widgets.NewQLabelFromPointer(w.FindChild("poc_reverse_url_label", core.Qt__FindChildrenRecursively).Pointer())
	...
	w.Poc_listen = widgets.NewQCheckBoxFromPointer(w.FindChild("poc_listen", core.Qt__FindChildrenRecursively).Pointer())
	w.Poc_file = widgets.NewQLineEditFromPointer(w.FindChild("poc_file", core.Qt__FindChildrenRecursively).Pointer())
	...
	w.Poc_url = widgets.NewQLineEditFromPointer(w.FindChild("poc_url", core.Qt__FindChildrenRecursively).Pointer())
	...
	w.Poc_reverse_url = widgets.NewQLineEditFromPointer(w.FindChild("poc_reverse_url", core.Qt__FindChildrenRecursively).Pointer())
	...
	w.Poc_reverse_url_check_label = widgets.NewQLabelFromPointer(w.FindChild("poc_reverse_url_check_label", core.Qt__FindChildrenRecursively).Pointer())
	...
	w.Poc_url_label = widgets.NewQLabelFromPointer(w.FindChild("poc_url_label", core.Qt__FindChildrenRecursively).Pointer())
	w.Poc_reverse_url_check = widgets.NewQLineEditFromPointer(w.FindChild("poc_reverse_url_check", core.Qt__FindChildrenRecursively).Pointer())
	...
	w.Poc_log = widgets.NewQTextEditFromPointer(w.FindChild("poc_log", core.Qt__FindChildrenRecursively).Pointer())
	w.Poc_import_file = widgets.NewQPushButtonFromPointer(w.FindChild("poc_import_file", core.Qt__FindChildrenRecursively).Pointer())
	...
	w.Poc_import_urls = widgets.NewQPushButtonFromPointer(w.FindChild("poc_import_urls", core.Qt__FindChildrenRecursively).Pointer())
